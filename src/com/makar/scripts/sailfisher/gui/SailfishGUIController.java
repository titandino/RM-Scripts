package com.makar.scripts.sailfisher.gui;

import java.net.URL;
import java.util.Map;
import java.util.ResourceBundle;

import com.makar.scripts.sailfisher.Sailfisher;
...
public class SailfishGUIController implements Initializable {

	private Sailfisher script;
	...
	public SailfishGUIController(Sailfisher script) {
		this.script = script;
	}
	...
	public void update() {
		fishTable.setItems(FXCollections.observableArrayList(script.getProducts().entrySet()));
		fishTable.refresh();
